...
public interface PainelDeAtendimentosRepositorio {
     ...
     *     consulta, nao de negocio (ATIVOS e sempre "meu" independente da flag; POTENCIAIS nunca e
     *     restrito por ela; TODOS so chega aqui depois da autorizacao centralizada em
     *     {@link VisaoAtendimento}). A RLS de {@code atendimento} continua sendo quem de fato impede
