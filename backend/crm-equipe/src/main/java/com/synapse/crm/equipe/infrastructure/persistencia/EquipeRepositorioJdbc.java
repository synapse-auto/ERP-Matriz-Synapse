...
@Repository class EquipeRepositorioJdbc implements EquipeRepositorio{private final JdbcTemplate jdbc;EquipeRepositorioJdbc(JdbcTemplate j){jdbc=j;}private static final String BASE="SELECT u.id,u.nome,u.email,u.senha_hash,u.papel::text,u.status_presenca::text,u.ativo,u.senha_alterada_em,COALESCE(d.disponivel_para_ia,FALSE) AS disponivel_para_ia FROM usuario u LEFT JOIN disponibilidade_atendente_ia d ON d.atendente_id=u.id";
