...
- Suíte completa Java 21 aprovada: `clean verify` com 762 integrações, sem falhas/skips. CI do PR #225 `36246914257` aprovada. Não considerar a paridade global concluída antes das evidências restantes.
