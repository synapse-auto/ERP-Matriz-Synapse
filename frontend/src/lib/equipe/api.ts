import{apiFetch}from"@/lib/api/http-client";import type{AvaliacoesEquipe,PapelGerenciavel,StatusPresenca,UsuarioEquipe}from"./types";
export const listarEquipe=()=>apiFetch<UsuarioEquipe[]>("/api/v1/usuarios");export const avaliacoesEquipe=()=>apiFetch<AvaliacoesEquipe>("/api/v1/equipe/avaliacoes");
