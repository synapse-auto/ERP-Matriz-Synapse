...
export interface UsuarioEquipe{id:string;nome:string;email:string;papel:PapelGerenciavel|"GESTOR"|"ADMINISTRADOR";statusPresenca:StatusPresenca;ativo:boolean;disponivelParaIa?:boolean;fotoUrl?:string|null}
...
export interface MeuUsuario{id:string;nome:string;email:string;papel:PapelGerenciavel|"GESTOR"|"ADMINISTRADOR";presenca:StatusPresenca;telefone:string|null;cargo:string|null;fotoUrl:string|null;senhaAlteradaEm:string|null}
