...
const TEXTOS = {
  ...
  login: {
    ...
    destaques: {
      crm: { titulo: "CRM", descricao: "" },
      atendimento: { titulo: "Atendimento", descricao: "" },
      iaAssistente: { titulo: "IA Assistente", descricao: "" },
    },
    campoEmail: "E-mail",
    campoSenha: "Senha",
    ...
    semAcesso: "Não tem acesso? Fale com o administrador da sua instância.",
    rodape: "© 2026 Synapse · Automação inteligente",
