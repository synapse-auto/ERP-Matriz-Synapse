        ...
        {mensagem.tipo === "CONTATO" && (
          <BolhaContato
            ...
            textos={{
              ...
              abrirConversa: textos.abrirConversa,
              abrirConversaCom: textos.abrirConversaCom,
              procurandoConversa: textos.procurandoConversa,
              conversaNaoEncontrada: textos.conversaNaoEncontrada,
              iniciarNovoContato: textos.iniciarNovoContato,
              iniciarNovoContatoCom: textos.iniciarNovoContatoCom,
              telefoneInvalidoParaConversa: textos.telefoneInvalidoParaConversa,
              erroAbrirConversa: textos.erroAbrirConversa,
              tentarAbrirConversaDeNovo: textos.tentarAbrirConversaDeNovo,
