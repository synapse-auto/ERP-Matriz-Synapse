...
| `WHATSAPP_USUARIO_API` / `WHATSAPP_VERSAO_API` | vazio | `{username}`/`{version}` da rota da Uzapi/Autotic (E152, provedor `uzapi-autotic`). Só essa instância usa; vazio não afeta `meta-cloud`. |
